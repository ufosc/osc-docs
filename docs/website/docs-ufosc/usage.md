...
This section requires a local installation of the project repository. For installation instructions, refer to the [Installation Guide](/docs/website/docs-ufosc/installation).
...
Then, the `serve` command (see [Serving Locally](/docs/website/docs-ufosc/usage#serving-locally)) may be used to test the site before releasing it to the public.
