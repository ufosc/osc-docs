 ...
 * [Admin Dashboard](/docs/website/ufosc/legacy/admin): User guide to using the website's built-in content management system.
 * [Developers](/docs/website/ufosc/legacy/Developers/introduction): Developer documentation for contributing/modifying the OSC website.
 * [API Reference](/docs/website/ufosc/legacy/api-reference): Reference of the site's public API.
