...
The users route interfaces with the users  [database model](/docs/website/ufosc/legacy/Developers/Databases/models) and serves users using their database ID.
