...
1. Blog metadata and rendered HTML articles (documented in [Developers/API/blog](/docs/website/ufosc/legacy/Developers/API/blog)).
2. Passing contact messages to the SMTP mail server (documented in [Developers/API/contact](/docs/website/ufosc/legacy/Developers/API/contact)).
3. Serving the various editable forms (documented in [Developers/API/edit](/docs/website/ufosc/legacy/Developers/API/edit)).
4. User authentication (documented in [Developers/API/users](/docs/website/ufosc/legacy/Developers/API/users)).
